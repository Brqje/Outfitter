...
Outfitter.OUTFIT_MESSAGE_COLOR_MSBT_R = Outfitter.OUTFIT_MESSAGE_COLOR.r * 255
Outfitter.OUTFIT_MESSAGE_COLOR_MSBT_G = Outfitter.OUTFIT_MESSAGE_COLOR.g * 255
Outfitter.OUTFIT_MESSAGE_COLOR_MSBT_B = Outfitter.OUTFIT_MESSAGE_COLOR.b * 255
				...
				if vCategoryID == "Complete" then
					...
					if not self.Settings.Options.DisableHotkeyMessages then
						if (IsAddOnLoaded("MikScrollingBattleText")) then
							MikSBT.DisplayMessage(format(self.cEquipOutfitMessageFormat, vOutfit:GetName()), nil, false, self.OUTFIT_MESSAGE_COLOR_MSBT_R, self.OUTFIT_MESSAGE_COLOR_MSBT_G, self.OUTFIT_MESSAGE_COLOR_MSBT_B)
						else
